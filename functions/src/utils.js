...
const mapValue = (value) => {
  ...
  const isGeopointType =
    latitude != null && longitude != null && (length == 2 || hasGeohashField);
  ...
  if (
    ...
    return Object.fromEntries(
        Object.entries(value).map(([key, value]) => [key, mapValue(value)]),
    );
  } else {
    return value;
  }
...
exports.typesenseDocumentFromSnapshot = async (
  ...
  const mappedDocument = Object.fromEntries(
