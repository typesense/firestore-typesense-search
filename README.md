...
| Flatten Firestore Documents | Should the Firestore documents be flattened before they are indexed in Typesense? Set to "Yes" for Typesense versions less than v0.24. Nested objects are only supported from v0.24. |
